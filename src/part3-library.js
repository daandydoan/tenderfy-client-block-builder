...
const RESUMES = [
  {id:'r1', name:'Sam Whitlock',  role:'Managing Director',        av:'#38988A', skills:['Email Marketing','Bid strategy'], layout:'left-panel', accent:'#38988A', status:'live',   by:'Jordan Avery', updated:'12 Jul 2026', pages:2},
  {id:'r2', name:'Morgan Ellis',   role:'Design Manager',           av:'#5C6BC0', skills:['Design coordination'],           layout:'top-band',   accent:'#2F6DF6', status:'live',   by:'Jordan Avery', updated:'04 Jul 2026', pages:2,
   data:{name:'Morgan Ellis', role:'Design Manager', contact:['priya.nair@example.com','+61 400 111 222','Brisbane, QLD'],
  ...
  {id:'r3', name:'Riley Chen',   role:'Site Supervisor',          av:'#EF6C00', skills:['Traffic control'],               layout:'minimal',    accent:'#B4530A', status:'draft',  by:'Riley Chen',      updated:'28 Jun 2026', pages:1,
   data:{name:'Riley Chen', role:'Site Supervisor', contact:['kenzie.may@example.com','+61 400 333 444','Ipswich, QLD'],
     summary:'Site supervisor with 9 years running civil crews on live traffic corridors and night-shift packages.',
     experience:[{t:'Site Supervisor - Tenderfy Civil', d:'2020-Present', b:'Ran night-shift crews of 18 on the Northern Arterial extension.'}],
  ...
  {id:'r4', name:'Casey Brooks',      role:'Contracts Administrator',  av:'#6D4C41', skills:['Progress claims'],               layout:'timeline',   accent:'#8A46B8', status:'review', by:'Jordan Avery', updated:'21 Jun 2026', pages:2,
   data:{name:'Casey Brooks', role:'Contracts Administrator', contact:['sam.lee@example.com','+61 400 555 666','Brisbane, QLD'],
  ...
  {id:'r5', name:'Alex Iverson',     role:'Estimator',                av:'#00838F', skills:['Cost planning'],                 layout:'minimal',    accent:'#0E7C86', status:'draft',  by:'Alex Iverson',        updated:'18 Jun 2026', pages:1,
   data:{name:'Alex Iverson', role:'Estimator', contact:['aj.jones@example.com','+61 400 777 888','Brisbane, QLD'],
     ...
     accreditations:['Cert IV Building & Construction'], referees:['Available on request']}},
  {id:'r6', name:'Devon Marsh', role:'Group General Manager', av:'#827717', skills:['Governance'],                    layout:'top-band',   accent:'#C0392B', status:'live',   by:'Jordan Avery', updated:'09 Jun 2026', pages:2,
   data:{name:'Devon Marsh', role:'Group General Manager', contact:['j.balani@example.com','+61 400 999 000','Sydney, NSW'],
...
const CASE_STUDIES = [
  {id:'c1', title:'Northern Arterial Extension', client:'State Roads Authority', sector:'Civil Infrastructure', cats:'Conservation', layout:'hero',   accent:'#38988A', status:'live',   by:'Jordan Avery', updated:'14 Jul 2026', pages:3},
  {id:'c2', title:'Southgate School Upgrade',        client:'Halewood Group',                sector:'Education',            cats:'N/A',          layout:'split',  accent:'#2F6DF6', status:'live',   by:'Morgan Ellis',      updated:'02 Jul 2026', pages:2,
   data:Object.assign({}, CS_DATA, {title:'Southgate School Upgrade', client:'Halewood Group', sector:'Education', location:'Southgate, QLD', value:'$4.8M', duration:'11 months', completed:'January 2026',
     ...
     quote:'They understood that a school does not stop for a builder. Not one lesson was lost.', quoteBy:'Casey Brooks - Business Manager, Halewood Group'})},
  {id:'c3', title:'Civic Centre Redevelopment',      client:'Buildcorp QLD',                  sector:'Commercial',           cats:'Conservation', layout:'report', accent:'#B4530A', status:'draft',  by:'Jordan Avery', updated:'19 Jun 2026', pages:2,
   data:Object.assign({}, CS_DATA, {title:'Civic Centre Redevelopment', client:'Buildcorp QLD', sector:'Commercial', location:'Brisbane, QLD', value:'$9.1M', duration:'14 months', completed:'November 2025',
     ...
     quote:'The heritage approach was thought through before a single tool came out of the truck.', quoteBy:'Dana Whitfield - Council Project Lead'})},
  {id:'c4', title:'Lakeside Foreshore Renewal',    client:'Lakeside Council',             sector:'Marine & Coastal',     cats:'Conservation', layout:'hero',   accent:'#0E7C86', status:'live',   by:'Morgan Ellis',      updated:'30 May 2026', pages:3,
   data:Object.assign({}, CS_DATA, {title:'Lakeside Foreshore Renewal', client:'Lakeside Council', sector:'Marine & Coastal', location:'Lakeside, QLD', value:'$6.7M', duration:'9 months', completed:'April 2026',
     ...
     quote:'The community barely noticed a major seawall renewal was under way. That is the highest praise we can give.', quoteBy:'Riley Chen - Coastal Asset Manager'})},
];

/* Cover pages — the live app keeps these under Tenders > Cover Pages. */
const COVERS = [
  {id:'cv1', name:'Company Cover - Logo Right',       font:'Tungsten-Narrow', bg:'#172E39', tx:'#B4D33B', logo:'right',  logoFile:'Tenderfy_Civil_logo.svg', status:'live'},
  {id:'cv2', name:'Company Cover - Logo Bottom Right',font:'Tungsten-Narrow', bg:'#1B2422', tx:'#FFBE0B', logo:'bottom', logoFile:'Tenderfy_Civil_logo.svg', status:'live'},
  {id:'cv3', name:'Company Cover',                    font:'Manrope',         bg:'#094074', tx:'#ACBDE3', logo:'right',  logoFile:'Tenderfy_Civil_logo.svg', status:'draft'},
];
...
const TOCS = [
  {id:'t1', name:'Standard Contents',            font:'Manrope', bg:'#2C3232', sec:'#38988A', logo:'Tenderfy_Civil_logo.svg', status:'live',  by:'Jordan Avery', updated:'11 Jul 2026'},
  {id:'t2', name:'Standard Contents - Light',    font:'Manrope', bg:'#F7F9F8', sec:'#38988A', logo:'Tenderfy_Civil_logo.svg', status:'live',  by:'Jordan Avery', updated:'11 Jul 2026'},
  {id:'t3', name:'Detailed Contents (numbered)', font:'Outfit',  bg:'#094074', sec:'#ACBDE3', logo:'Tenderfy_Civil_logo.svg', status:'draft', by:'Morgan Ellis',      updated:'26 Jun 2026'},
  {id:'t4', name:'Contents - Accent',            font:'Poppins', bg:'#584A4B', sec:'#EF8354', logo:'Tenderfy_Civil_logo.svg', status:'live',  by:'Morgan Ellis',      updated:'26 Jun 2026'},
];
...
const OTHER_DOCS = {
  policies:[
    {t:'WHS Policy 2026', tag:'PDF', pages:4, by:'Jordan Avery', updated:'02 Jul 2026', desc:'Work Health &amp; Safety Policy - Tenderfy Civil Pty Ltd. Sets out responsibilities, consultation arrangements and the hazard management framework applied on every site&hellip;'},
    {t:'Environmental Policy', tag:'PDF', pages:3, by:'Jordan Avery', updated:'02 Jul 2026', desc:'Commitment to environmental protection, waste minimisation and compliance with the Environmental Protection Act on all works&hellip;'},
    {t:'Quality Management Policy', tag:'DOCX', pages:2, by:'Morgan Ellis', updated:'18 Jun 2026', desc:'Quality objectives, ITP framework and non-conformance handling aligned to ISO 9001:2015&hellip;'},
    {t:'Drug &amp; Alcohol Policy', tag:'PDF', pages:2, by:'Riley Chen', updated:'11 Jun 2026', desc:'Testing regime, thresholds and rehabilitation pathway for all site-based personnel and subcontractors&hellip;'},
  ],
  insurances:[
    {t:'Public Liability Insurance', tag:'PDF', pages:3, by:'Jordan Avery', updated:'01 Jul 2026', exp:'2026-09-30', rem:30, desc:'Certificate of Currency - Public Liability. Insured: Tenderfy Civil Pty Ltd. Limit of liability: $20,000,000 any one occurrence&hellip;'},
    {t:'Workers Comp Certificate', tag:'PDF', pages:2, by:'Jordan Avery', updated:'01 Jul 2026', exp:'2026-09-05', rem:30, desc:'Confirms a current workers&rsquo; compensation policy under the Workers&rsquo; Compensation and Rehabilitation Act&hellip;'},
    {t:'Professional Indemnity', tag:'PDF', pages:2, by:'Jordan Avery', updated:'01 Jul 2026', exp:'2027-02-28', rem:60, desc:'Professional Indemnity cover to $10,000,000 for design and construct obligations&hellip;'},
    {t:'Plant &amp; Equipment Cover', tag:'PDF', pages:1, by:'Riley Chen', updated:'22 Jun 2026', exp:'2026-08-31', rem:30, desc:'Mobile plant and contractors&rsquo; equipment cover, scheduled items to $2,400,000&hellip;'},
  ],
  certifications:[
    {t:'QBCC Contractor Licence', tag:'PDF', pages:1, by:'Jordan Avery', updated:'20 May 2026', exp:'2027-05-20', rem:60, desc:'Licence No. QLD 000 749-0. Class: Civil &amp; Traffic Management. Authorised to carry out the classes of work listed&hellip;'},
    {t:'ISO 9001:2015 Certificate', tag:'PDF', pages:2, by:'Morgan Ellis', updated:'14 Apr 2026', exp:'2027-04-14', rem:60, desc:'Certified quality management system covering civil construction and infrastructure delivery&hellip;'},
    {t:'ISO 45001 Certificate', tag:'PDF', pages:2, by:'Morgan Ellis', updated:'14 Apr 2026', exp:'2027-04-14', rem:60, desc:'Certified occupational health and safety management system, scope: civil construction&hellip;'},
    {t:'White Card - K. May', tag:'PDF', pages:1, by:'Riley Chen', updated:'15 Jan 2026', exp:'2027-01-15', rem:60, desc:'General Construction Induction Card No. 0048213 issued under the Work Health and Safety Regulation&hellip;'},
  ],
  'organization-chart':[
    {t:'Company Org Chart 2026', tag:'PDF', pages:1, by:'Jordan Avery', updated:'09 Jul 2026', desc:'Board, executive, delivery and support functions with reporting lines for Tenderfy Civil Pty Ltd&hellip;'},
    {t:'Project Org Chart - Northern Arterial', tag:'DOCX', pages:1, by:'Morgan Ellis', updated:'27 Jun 2026', desc:'Project-specific structure: project director, PM, design manager, site supervision and subcontract interfaces&hellip;'},
  ],
  others:[
    {t:'Capability Statement 2026', tag:'PDF', pages:8, by:'Jordan Avery', updated:'12 Jul 2026', desc:'Company profile, key personnel, plant and equipment schedule, recent projects and referees for Tenderfy Civil Pty Ltd&hellip;'},
    {t:'Plant &amp; Equipment Schedule', tag:'XLSX', pages:3, by:'Riley Chen', updated:'30 Jun 2026', desc:'Owned and hired plant with capacities, service status and current allocation by project&hellip;'},
    {t:'Referee List', tag:'DOCX', pages:1, by:'Jordan Avery', updated:'12 Jun 2026', desc:'Nominated client referees with role, project and contact details, refreshed each quarter&hellip;'},
    {t:'Sustainability Statement', tag:'PDF', pages:4, by:'Morgan Ellis', updated:'05 Jun 2026', desc:'Emissions reduction targets, recycled material commitments and reporting method for tender responses&hellip;'},
  ],
};
